...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  User create(User user)")
	fmt.Fprintln(os.Stderr, "  User read(string userId)")
	fmt.Fprintln(os.Stderr, "  User update(User user)")
	fmt.Fprintln(os.Stderr, "  void destroy(string userId)")
